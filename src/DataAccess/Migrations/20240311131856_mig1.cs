    ...
    public partial class mig1 : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_role_operation_claims", x => x.id);
                    table.ForeignKey(
                        name: "FK_role_operation_claims_operation_claims_operation_claim_id",
                        column: x => x.operation_claim_id,
                        principalTable: "operation_claims",
                        principalColumn: "id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_role_operation_claims_roles_role_id",
                        column: x => x.role_id,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_role_operation_claims_operation_claim_id",
                table: "role_operation_claims",
                column: "operation_claim_id");

            migrationBuilder.CreateIndex(
                name: "IX_role_operation_claims_role_id",
                table: "role_operation_claims",
                column: "role_id");
